...
expect.extend({
  ...
  toHaveError: matchers.createMatcher$1(expect, jestDiff.diff),
  toHaveErrors: matchers.createMatcher(expect, jestDiff.diff),
  toMatchCodeframe: matchersJestonly.createMatcher$1(),
  toMatchInlineCodeframe: matchersJestonly.createMatcher()
});
