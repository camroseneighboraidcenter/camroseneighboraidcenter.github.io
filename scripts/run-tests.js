...
const testBatches = [
  {
    ...
    command:
      'npx playwright test tests/accessibility.spec.ts --project=chromium-light --project=chromium-dark --grep="Home|About|Contact|Donate|Programs"',
  },
  {
    name: "Accessibility - Program Pages",
    command:
      'npx playwright test tests/accessibility.spec.ts --project=chromium-light --project=chromium-dark --grep="Food Bank|Food for Kids|Martha|Medical|Emergency|Referral"',
  },
  {
    name: "Accessibility - 404 Page",
    command:
      'npx playwright test tests/accessibility.spec.ts --project=chromium-light --project=chromium-dark --grep="404"',
  },
  {
    name: "SEO Tests",
  ...
  },
  {
    ...
    command:
      "npx playwright test tests/visual.spec.ts --project=chromium-light",
  },
  {
  ...
  },
  {
    name: "Mobile Tests",
    command:
      'npx playwright test tests/accessibility.spec.ts --project=mobile-chrome --project=mobile-safari --grep="Home|About|Contact"',
  },
  {
    name: "Cross-browser Tests",
    command:
      'npx playwright test tests/accessibility.spec.ts --project=firefox --project=webkit --grep="Home|About|Contact"',
  },
  {
    name: "Lighthouse CI",
...
function cleanup() {
  ...
  const dirsToClean = ["test-results", "playwright-report", ".lhci"];
